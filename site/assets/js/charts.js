...
function createTeamPerformanceChart() {
  ...
  new Chart(ctx, {
    type: 'bar',
    data: {
      labels: ['João Silva', 'Ana Costa', 'Carlos Lima', 'Maria Santos', 'Roberto Dias'],
      datasets: [{
...
function createLeadSourceChart() {
  ...
  new Chart(ctx, {
    type: 'pie',
    data: {
      labels: ['WhatsApp', 'Instagram', 'Google Ads', 'Facebook', 'LinkedIn', 'Indicação'],
      datasets: [{
        ...
        tooltip: {
          ...
          callbacks: {
            label: function(context) {
              ...
              if (context.parsed !== null) {
                label += context.parsed + '% dos leads';
              }
              return label;
            }
          }
